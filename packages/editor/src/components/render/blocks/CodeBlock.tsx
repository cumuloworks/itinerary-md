...
export const CodeBlock: React.FC<{
    ...
    const codeClass = [lang ? `language-${lang}` : undefined, 'hljs'].filter(Boolean).join(' ');
    ...
    const mergedClassName = mergeClassNames('border border-gray-300 overflow-x-auto my-4 ml-20 text-sm', extraClass as string | undefined);
    return (
