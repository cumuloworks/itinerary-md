...
export const Price: React.FC<{
  ...
  const textClassName = hasError
    ? 'ml-1 underline decoration-wavy decoration-red-500 decoration-from-font underline-offset-2'
    : undefined;
  ...
  if (display) {
    return (
      <IconLabelText
        icon={Icon}
        label={undefined}
        segments={[{ text: display }]}
        className="flex items-center text-sm font-bold text-emerald-600"
        iconSize={14}
        iconClassName="mr-1"
