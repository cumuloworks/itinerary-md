...
const MonacoEditorComponent: FC<MonacoEditorProps> = ({
  value,
  onChange,
  onSave,
  onCursorLineChange,
  ...
  const cursorLineChangeRef =
    useRef<MonacoEditorProps['onCursorLineChange']>(undefined);
  const changedLinesRef =
    useRef<MonacoEditorProps['onChangedLines']>(undefined);
...
function useToggleCompletions(
  enabled: boolean,
  monacoRef: React.RefObject<any>,
  disposablesRef: React.RefObject<{ dispose: () => void } | null>
): void {
  useEffect(() => {
