...
describe('MonacoEditor', () => {
    ...
    it('defines required props', () => {
      render(
        <MonacoEditor
          ...
          onChangedLines={mockOnChangedLines}
        />
      );
  ...
  describe('Edge cases', () => {
    ...
    it('handles empty content', () => {
      render(
        <MonacoEditor value="" onChange={mockOnChange} onSave={mockOnSave} />
      );
  ...
  describe('Timezone autocomplete', () => {
    ...
    it('provides timezone suggestions when @ is typed', () => {
      ...
      const utcOffsets = result.suggestions.filter(
        (s: any) => s.detail === 'UTC Offset'
      );
    ...
    it('provides IANA timezones only (no UTC offsets)', () => {
      ...
      const ianaTimezones = result.suggestions.filter(
        (s: any) => s.detail === 'Timezone'
      );
