  ...
  DropdownMenu: {
    ...
    RadioGroup: ({
      ...
      <div
        ...
        data-value={value}
        data-change={typeof onValueChange === 'function'}
      >
        {children}
      </div>
    ),
...
describe('TopBar', () => {
  ...
  describe('Rendering', () => {
    ...
    it('applies custom class name', () => {
      const { container } = render(
        <TopBar {...mockProps} className="custom-class" />
      );
  ...
  describe('View mode', () => {
    ...
    it('supports different view modes', () => {
      ...
      rerender(
        <TopBar
          {...mockProps}
          topbar={{ ...mockProps.topbar, viewMode: 'editor' }}
        />
      );
      expect(screen.getByTestId('toggle-group')).toHaveAttribute(
        'data-value',
      ...
      rerender(
        <TopBar
          {...mockProps}
          topbar={{ ...mockProps.topbar, viewMode: 'preview' }}
        />
      );
      expect(screen.getByTestId('toggle-group')).toHaveAttribute(
        'data-value',
  ...
  describe('Hide past toggle', () => {
    ...
    it('shows ON when showPast is false', () => {
      render(
        <TopBar
          {...mockProps}
          topbar={{ ...mockProps.topbar, showPast: false }}
        />
      );
  ...
  describe('Edge cases', () => {
    ...
    it('handles invalid timezone formats', () => {
      render(
        <TopBar {...mockProps} timezoneOptions={['Invalid/Zone', 'UTC']} />
      );
