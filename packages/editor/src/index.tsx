...
export const Editor: FC<EditorProps> = (props) => {
  ...
  const effectiveFonts: EditorFontsOption =
    props.fonts === undefined ? defaultFonts : props.fonts;
  const effectiveMonoFonts: EditorFontsOption =
    props.monoFonts === undefined ? defaultMonoFonts : props.monoFonts;
      ...
      <TelemetryContext.Provider value={props.telemetry}>
        <ErrorBoundary>
          <I18nProvider language={props.language}>
            <Suspense
              fallback={
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-300 bg-white p-4 text-gray-500">
                  Loading editor...
                </div>
              }
            >
