export function findBestTargetForLine(
  container: HTMLElement,
  line: number
): { target: HTMLElement | null; boxTarget: HTMLElement | null } {
...
export function isElementVisibleWithin(
  container: HTMLElement,
  el: HTMLElement,
  margin = 8
): boolean {
...
export function scrollElementIntoCenteredView(
  container: HTMLElement,
  el: HTMLElement
) {
  const cRect = container.getBoundingClientRect();
