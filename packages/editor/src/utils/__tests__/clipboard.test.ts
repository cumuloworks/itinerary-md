  ...
  describe('writeTextToClipboard', () => {
    ...
    describe('Textarea fallback method', () => {
      ...
      it('sets textarea attributes correctly', async () => {
        ...
        const originalAppendChild = document.body.appendChild.bind(
          document.body
        );
      ...
      it('preserves existing selection range', async () => {
        ...
        await expect(
          writeTextToClipboard('preserve selection')
      ...
      it('restores focus to the previously active element', async () => {
        ...
        // Do not test textarea fallback details here
        await expect(
          writeTextToClipboard('restore focus')
        ).resolves.toBeUndefined();
      ...
      it('performs cleanup even when an error occurs', async () => {
        ...
        await expect(writeTextToClipboard('error test')).rejects.toThrow(
          'execCommand error'
        );
      });
    });
    ...
    describe('Edge cases', () => {
      ...
      it('preserves multiple selection ranges', async () => {
        ...
        // Do not test textarea fallback details here
        await expect(
          writeTextToClipboard('multiple ranges')
        ).resolves.toBeUndefined();
      });
      ...
      it('handles when the active element is not focusable', async () => {
        ...
        await expect(
          writeTextToClipboard('no focus element')
        ).resolves.toBeUndefined();
      });
      ...
      it('handles null activeElement', async () => {
        ...
        await expect(
          writeTextToClipboard('null active')
        ).resolves.toBeUndefined();
      });
      ...
      it('handles null selection', async () => {
        ...
        await expect(
          writeTextToClipboard('no selection')
        ).resolves.toBeUndefined();
