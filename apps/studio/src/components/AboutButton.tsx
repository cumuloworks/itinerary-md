			...
			{open && (
				...
				>
					...
					>
						<div
							role="document"
							className="relative bg-white rounded-lg max-w-lg w-[90vw] p-6 shadow-xl"
						>
							{showThanks ? (
								// Thank you state - show for 3 seconds or until clicked
								<button
									type="button"
									className="flex flex-col items-center py-8 cursor-pointer w-full focus:outline-none"
...
- Use of this studio is provided as-is without warranty.`}
									...
									<div className="mt-6 flex justify-between items-center gap-2">
										<button
											type="button"
											className="px-3 py-1.5 text-sm rounded border border-gray-300 text-gray-700 hover:bg-gray-50 inline-flex items-center gap-1"
